        ...
        <ContainerBg>
          <ModalBlock>
            <ModalContent>
              ...
              <ModalFormNewArt>
                <FormNewArtBlock>
                  <FormNewArtLabel id="title" for="name">
                    Название
                  </FormNewArtLabel>
                  <FormNewArtInput
                ...
                <FormNewArtBlock>
                  <FormNewArtP>
                    Фотографии товара
                    <FormNewArtPSpan>не более 5 фотографий</FormNewArtPSpan>
                  </FormNewArtP>
                  <FormNewArtBarImg>
                    <FormNewArtImgContainer>
                      <FormNewArtImg />
                      <FormNewArtImgCoverInputLabel for="file-upload">
                        <FormNewArtImgCover onClick={handlePhotoClick}>
                          <AdvtImg
                            src={
                              imgSelected === undefined || quantityOfPic < 1
                                ? ""
                                : imgSelected[0]?.selectedImg
                                ? imgSelected[0]?.selectedImg
                                : `http://localhost:8090/${imgSelected[0]?.url}`
                            }
                            id="0"
                          />
                        </FormNewArtImgCover>
                    ...
                    >
                      ...
                      <FormNewArtImgCoverInputLabel for="file-upload">
                        <FormNewArtImgCover onClick={handlePhotoClick}>
                          <AdvtImg
                            src={
                              imgSelected === undefined || quantityOfPic < 2
                                ? ""
                                : imgSelected[1]?.selectedImg
                                ? imgSelected[1]?.selectedImg
                                : `http://localhost:8090/${imgSelected[1]?.url}`
                            }
                            id="1"
                          />
                        </FormNewArtImgCover>
                    ...
                    >
                      ...
                      <FormNewArtImgCoverInputLabel for="file-upload">
                        <FormNewArtImgCover onClick={handlePhotoClick}>
                          <AdvtImg
                            src={
                              imgSelected === undefined || quantityOfPic < 3
                                ? ""
                                : imgSelected[2]?.selectedImg
                                ? imgSelected[2]?.selectedImg
                                : `http://localhost:8090/${imgSelected[2]?.url}`
                            }
                            id="2"
                          />
                        </FormNewArtImgCover>
                    ...
                    >
                      ...
                      <FormNewArtImgCoverInputLabel for="file-upload">
                        <FormNewArtImgCover onClick={handlePhotoClick}>
                          <AdvtImg
                            src={
                              imgSelected === undefined || quantityOfPic < 4
                                ? ""
                                : imgSelected[3]?.selectedImg
                                ? imgSelected[3]?.selectedImg
                                : `http://localhost:8090/${imgSelected[3]?.url}`
                            }
                            id="3"
                          />
                        </FormNewArtImgCover>
                    ...
                    >
                      ...
                      <FormNewArtImgCoverInputLabel for="file-upload">
                        <FormNewArtImgCover onClick={handlePhotoClick}>
                          <AdvtImg
                            src={
                              imgSelected === undefined || quantityOfPic < 5
                                ? ""
                                : imgSelected[4]?.selectedImg
                                ? imgSelected[4]?.selectedImg
                                : `http://localhost:8090/${imgSelected[4]?.url}`
                            }
                            id="4"
                          />
                        </FormNewArtImgCover>
