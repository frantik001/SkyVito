      ...
      <Wrapper>
        <Container>
          ...
          <main>
              ...
              <ArticContent>
                <ArticleLeft>
                  <ArticleFillImg>
                    ...
                    <ArticleImgBarMob
                      containerWidth={`${adv?.images?.length * 11.333}px`}
                    >
                      {adv?.images?.map((img, index) => (
                        <ImgBarMobCircle
                          onClick={HandleImgBarMobCircle}
                          id={index}
                          key={index}
                          active={nextImg === index ? "#FFFFFF" : ""}
                        />
                      ))}
                    </ArticleImgBarMob>
                  </ArticleFillImg>
                ...
                <ArticleRight>
                  <ArticleBlock>
                    ...
                    <ArticleBtnBlock myadvt={!myadvt ? "none" : "flex"}>
                      ...
                      <ArticleBtnRemove onClick={handleDeletedAdvt}>
                        Снять с публикации
                      </ArticleBtnRemove>
                    </ArticleBtnBlock>
                    <ArticleAuthor>
            ...
            <MainContainer>
              <Maintitle>Описание товара</Maintitle>
              <MainContent>
                <MainText>{adv?.description}</MainText>
              </MainContent>
            </MainContainer>
          </main>
